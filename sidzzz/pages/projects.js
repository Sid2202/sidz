...
function Projects(props) {
  const renderFeatured = () => {
    const featured = ['Spendwise', 'Hyper3', 'Samyak', 'Meta Video']
  ...
  const description = `I'm obsessed with side projects and <strong>building in public</strong>. Here you can navigate to different websites, apps, and libraries I built. Some projects are still active, others have been discontinued.`
