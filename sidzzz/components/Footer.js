...
export default function Footer() {
  const links = [
    {
      title: 'Email',
      url: 'mailto:sidpatil2209@gmail.com',
      icon: 'ri-mail-line',
    },
    {
      title: 'Twitter',
      url: 'https://x.com/Sidhanti22',
      icon: 'ri-twitter-line',
    },
    {
      title: 'GitHub',
      url: 'https://github.com/Sid2202',
      icon: 'ri-github-line',
    },
    {
      title: 'linkedin',
      url: 'https://www.linkedin.com/in/sidhanti-patil',
      icon: 'ri-linkedin-line',
    },
    {
      title: 'Instagram',
      url: 'https://www.instagram.com/sidhanti_patil',
