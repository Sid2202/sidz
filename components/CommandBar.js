...
// import resumeIcon from '../public/static/icons/resume.jpeg'
...
export default function CommandBar(props) {
  ...
  const actions = [
    ...
    },
    {
      ...
      keywords: 'send-email',
      section: 'General',
      perform: () => router.push('mailto:sidpatil2209@gmail.com'),
    ...
    },
    {
      ...
      perform: () =>
        // CHANGE THIS
        window.open('https://github.com/sidzzz/sidzzz.com', '_blank'),
